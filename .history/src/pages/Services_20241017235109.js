      ...
      return (
            <div>
                  <section class="relative  bg-blueGray-50">
                        <div class="relative pt-16 pb-32 flex content-center bg-darkgrey items-center justify-center min-h-screen-75">
                              <div class="absolute top-0 w-full h-full bg-center bg-cover">
                                    <span
                                          id="blackOverlay"
                                          class="w-full h-full absolute opacity-75 bg-darkgrey"
                                    />
                              </div>
                              <div class=" relative mx-auto">

                                          <div class="w-full lg:w-full px-4 text-center">
                                                <div class="flex justify-center flex-col items-center w-full text-white">
                              ...
                              <div class="top-auto bottom-0 left-0 right-0 w-full pointer-events-none overflow-hidden h-70-px">
                                    <svg
