                              ...
                              <div class="px-4">
                                    {
                                        ...
                                        <div class="flex flex-col overflow-wrap gap-2 md:flex-row">
                                        {
                                            list.map((item, index) => {
                                                return (
                                                      <div class="lg:pt-12 pt-6 w-full text-center">
                                                        <div class="relative flex flex-col break-words h-[45rem] shadow-darkgrey bg-white w-[22rem] shadow-lg rounded-lg">
                                                          <div>
                                                                <div>
                                                                  <img
