            ...
            <section id="services" className="bg-my_white text-my_black py-16 px-4">
                <div className="container mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        >
                                <h3 className="text-2xl font-bold mb-4 text-my_black">1. Box <img src='/images/Box Braids.jpg' alt='Box Braids'/>
                        ...
                        <motion.div
                            ...
                            className="bg-primary p-6 rounded-lg shadow-yellow transition-all duration-300"
                        >
                            <h3 className="text-2xl font-bold mb-4 text-my_black">6. Sign Style: Boho B src='/images/Boho Bob.jpg' alt='Sign Style Boho Bob'/>
                            <p className="text-lg mt-2">
