            ...
            <div className=" text-white bg-lightblue text-my_white font-montserrat flex flex-col">
                  <div className="flex flex-col h-full flex-1">
                        ...
                        >
                              ...
                              <div className="flex flex-col justify-center md:w-lvw gap-4">
                                    <a
                                          href="#services"
                                    ...
                                    <a
                                          href="#services"
                                          className="bg-primary md:w-[20rem]   text-my_white text-xl font-bold py-3 px-6 rounded-full hover:bg-black"
                                    >
