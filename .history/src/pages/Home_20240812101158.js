                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            <div className="flex justify-between">
                                ...
                                <h3 className="text-2xl font-bold mb-4 text-my_black">2</h3>
                            </div>
                        ...
                        >
                            <div className="flex justify-between">
                                ...
                                <h3 className="text-2xl font-bold mb-4 text-my_black">3</h3>
                            </div>
                        ...
                        {/* Rest of the cards */}
                        {/* Add the same structure for the remaining cards */}
                        {/* ... */}
                    </div>
                </div>
            </section>
