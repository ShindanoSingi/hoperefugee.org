...
function About() {
    return (
        <div className="flex items-center justify-center">
            <div className="md:max-w-2xl hover:bg-black hover:text-my_white lg:max-w-7xl mx-6">
                <motion.div
                ...
                >
                    <h2 className="text-2xl hover:bg-black hover:text-my_white text-my_green font-bold mb-4">
                        Welcome to our Hair Braiding Business!
                    </h2>
                    <p className="text-lg hover:bg-black hover:text-my_white text-my_black">
