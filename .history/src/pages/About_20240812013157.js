...
function About() {
    return (
        <div className="flex items-center hover:bg-black hover:text-my_white justify-center">
            <div className="md:max-w-2xl hover:bg-black hover:text-my_white rounded-lg  lg:max-w-7xl mx-6">
                ...
                >
                    <h2 className="text-2xl text-my_green hover:bg-black hover:text-my_white font-bold mb-4">
                        Welcome to our Hair Braiding Business!
                    </h2>
                    <h2 className="text-lg hover:bg-black hover:text-my_white text-my_black">
