...
function Home() {
    return (
        <div className="min-h-screen bg-my_black text-my_white font-montserrat flex flex-col">
            {/* Header Section */}
            <header className="bg-primary p-6 shadow-yellow">
                <div className="container mx-auto flex justify-between items-center">
                    <div className="text-3xl font-buffalo text-my_white">
                        <img src="/images/logo_no_background.png" alt="Logo" className="h-16" />
                    </div>
            ...
            <section className="flex-1 flex items-center justify-center bg-my_black relative">
                ...
                <motion.div
                    ...
                    className="relative z-10 text-center text-my_white"
                >
