                                    ...
                                    <div class="items-center shadow-md rounded-lg w-full lg:w-[60rem] shadow-black pb-12 px-6 flex flex-wrap">
                                          <div class="w-full text-center">
                                                <div class="pt-4 text-white">
                                                      ...
                                                      <p class="mt-4 text-lg md:text-xl lg:text-2xl text-blueGray-200">
                                                            We are dedicated to
                                                            providing
                                                            comprehensive
                                                      ...
                                                      <p class="mt-4 text-2xl md:text-3xl text-blueGray-200">
                                                            Our services are
                                                            designed to address
                                                            the unique needs of
                                                            newcomers at every
                              ...
                              <div class="px-4">
                                    {
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 gap-y-4">
                                        {
                                            list.map((item, index) => {
                                                return (
                                                      <div class="lg:pt-12 pt-6 w-full text-center">
                                                        <div class="relative flex flex-col break-words h-[48rem] shadow-darkgrey bg-white w-full  shadow-lg rounded-lg">
                                                          <div>
                                                                <div>
                                                                  <img
