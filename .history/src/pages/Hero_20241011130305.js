                  ...
                  <div className="flex flex-col h-full flex-1">
                        ...
                        >
                              ...
                              <div className="flex flex-col justify-center items-center md:w-lvw gap-4">
                                    <a
                                          href="#services"
                                          className="bg-blue-700 w-[20rem] text-my_white text-xl font-bold border-white border-2 py-3 px-6 rounded-full hover:bg-black"
                                    >
                                          Donate
                                    </a>
                                    <a
                                          href="#services"
                                          className="bg-primary w-[20rem] text-my_white text-xl font-bold border-lightblue border-2 py-3 px-6 rounded-full hover:bg-black"
                                    >
