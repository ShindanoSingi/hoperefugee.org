                                          ...
                                          <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                                                <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                                      <div class="px-2 py-2 flex-auto">
                                                            ...
                                                            <p class="mt-2 mb-4 md:text-xl text-blueGray-500">
                                                            Our employment services are designed to support immigrants in navigating the job market. We provide personalized guidance to help secure meaningful employment opportunities that align with skills and aspirations
                                                            </p>
                                                      </div>
                                                </div>
                                          </div>
