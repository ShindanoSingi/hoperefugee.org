...
function About() {
      ...
      return (
            <div className="flex items-center mt-4 flex-col justify-center">
                  ...
                  <div
  className="bg-cover bg-center grid place-content-center h-64 md:max-w-2xl lg:max-w-7xl mx-6"
  style={{ backgroundImage: 'url(https://taxilewiston.com/images/1469761/0_0.jpg)' }}
>
                        <div className="">
                        <p className="text-shadow-custom text-4xl font-bold text-my_white font-serif">ABOUT US</p>
                        </div>
                  </div>
            </div>
      );
