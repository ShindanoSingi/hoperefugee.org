...
const List = require("../constants/List").List;
                                            ...
                                            {List.map((item) => () => {
                                                return (
                                                      <div class="w-full md:w-1/2 px-4">
                                                            <div class="relative flex flex-col h-full break-words bg-white w-full mb-6 shadow-lg rounded-lg overflow-hidden">
                                                                  <div class="px-6 py-4">
                                                                        <h3 class="text-xl font-bold">{item.title}</h3>
                                                                        <p class="mt-2 text-sm text-blueGray-600">{item.description}</p>
                                                                  </div>
