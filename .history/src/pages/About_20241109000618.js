...
function About() {
    const handleDonate = () => {
        window.location.href = "https://www.zeffy.com/donation-form/donate-to-make-a-difference-822";
      };
      return (
                                    ...
                                    <div className="flex max-h-[80vh] overflow-auto md:landscape:h-[100%]   flex-col gap-6">
                                          ...
                                          <div className="glass p-4">
                                                ...
                                                <div className="flex justify-center text-white">
                                                    <Button onclick={handleDonate} type="primary" text='DONATE' border='white' hoverColor="primary"/>
                                                </div>
