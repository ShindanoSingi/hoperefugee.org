...
function About() {
    ...
    return (
        <div className="flex items-center mt-4 flex-col justify-center">
            ...
            <div id="about-promo-image" style="background-image: url(https://taxilewiston.com/images/1469761/0_0.jpg);"><div id="promo-image-title">
                        <p style="text-shadow: 2px 2px #3D3D3D; font-weight: 700; font-family: Oxygen;"> ABOUT US</p>
