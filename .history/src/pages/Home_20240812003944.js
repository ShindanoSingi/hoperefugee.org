...
function Home({ image, likes, stars, comments }) {
return <div>
    <h1>Home Page</h1>
    <Link to="/about">About</Link>
    <div className="grid grid-cols-3 gap-4">
        {/* {services.map(service => ( */}
        <motion.div // key={service.id} initial={{ opacity: 0, scale: 0 }} animate={{ opacity: 1, scale: 1 }}
            ...
            {/* <Card>
                ...
                <div className="flex items-center">
                    <div className="flex items-center">
                        ...
                        <svg key={index} xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-500"
