        ...
        <div className="flex items-center justify-center">
            <div className="md:max-w-2xl lg:max-w-7xl mx-6">
                <motion.div
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="bg-primary hover:bg-black rounded-lg shadow-md p-6"
                    role="button"
                    tabIndex={0}
                    aria-label="Clickable Div"
                >
                    <h2 className="text-2xl text-my_green hover:text-my_white font-bold mb-4">
                        Welcome to our Hair Braiding Business!
                    </h2>
                    <p className="text-lg hover:text-my_white text-my_black">
