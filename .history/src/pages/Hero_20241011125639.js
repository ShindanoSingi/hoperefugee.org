            ...
            <div className=" text-white bg-lightblue text-my_white font-montserrat flex flex-col">
                  <div className="flex flex-col h-full flex-1">
                        <motion.div
                              ...
                              className="relative z-5 text-center p-6 h-[23.5rem] bg-lightblue text-white"
                        >
                              ...
                              <div className="flex flex-col w-full md:w-screen gap-4 md:flex-row">
                                    <a
                                          href="#services"
                                          className="bg-blue-700 text-my_white text-xl font-bold border-white border-2 py-3 px-6 rounded-full hover:bg-black"
                                    >
                                          Donate
                                    </a>
                                    <a
