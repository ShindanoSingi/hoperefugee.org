...
function About() {
      return (
            <div className="grid bg-gray-800 place-content-center">
                  <div
                              ...
                              >
                                    <div className="flex max-h-[80vh] overflow-auto md:landscape:h-[100%]   flex-col gap-6">
                                          ...
                                          <div className="bg-gray-900 p-4">
                                                <h2 className="text-2xl underline text-white md:text-4xl font-bold mb-4">
                                                      What We Do
                                                </h2>
                                                <p className="text-lg mb-4 text-white font-bold md:text-3xl">
                                                      Initial Settlement
                                                      Assistance: Helping
