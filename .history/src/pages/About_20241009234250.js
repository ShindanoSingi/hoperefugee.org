...
function About() {
      ...
      return (
            <div className="grid place-content-center">
                  <div
                        className="bg-cover grid place-content-center  w-full h-screen"
                        style={{
                  ...
                  >
                        <motion.div
                              ...
                              whileTap={{ scale: 0.95 }}
                              className=" rounded-lg glass grid shadow-md max-w-[75%] p-6"
                              role="button"
                              tabIndex={0}
                        ...
                        >
                            <p className="text-lg text-my_black lg:text-2xl">
                                    At Refugee and Immigrant Compass, our
                                    mission is to empower immigrants to become
