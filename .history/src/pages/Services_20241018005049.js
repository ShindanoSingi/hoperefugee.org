                  ...
                  <section class="relative  bg-blueGray-50">
                        <div class="relative pt-12 pb-32 flex content-center bg-darkgrey items-center justify-center min-h-screen-75">
                              ...
                              <div class="w-full flex items-center justify-center">
                                    <div class="items-center shadow-md rounded-lg w-[45rem] lg:w-[60rem] shadow-black pb-12 px-4 flex flex-wrap">
                                    ...
                                    {/* <div className="border-b-2 shadow-lg mt-12 border-white"></div> */}
