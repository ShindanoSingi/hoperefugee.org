...
function Home() {
    ...
    const [comments1, setComments1] = useState([
      ["Great service!", "Love the braids!", "Love the braids! Love the braids! Love the braids!", "Love the braids!", "Love the braids!", "Love the braids!", "Love the braids!", "Love the braids!", "Love the braids!", "Love the braids!"],
      ["Amazing styles."],
      ["Very professional."],
      ["Very professional."],
      ["Very professional."],
            ...
            <div className="min-h-screen bg-my_black text-my_white font-montserrat flex flex-col">
                  ...
                  <section className="flex-1 flex items-center justify-center bg-my_black relative">
                        ...
                        >
                              ...
                              <a
                                    href="#services"
                                    className="bg-primary text-my_black font-bold py-3 px-6 rounded-full shadow-yellow hover:bg-my_white"
                              >
                  ...
                  >
                        <div className="container mx-auto">
                              <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-my_green">
                                    Our Services
                              </h2>
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    ...
                                    {[
                                          ...
                                          >
                                                <h3 className="text-2xl font-bold mb-4 text-my_black">
                                                      {service.title}
                                                </h3>
                                                <img
                                                      src={service.img}
                                                ...
                                                <div className="mt-4 flex justify-between items-center">
                                                      <div className="flex flex-col items-center">
                                                            <button
                                                                  ...
                                                                  className="text-my_black font-bold hover:text-my_white"
                                                            >
                                                                  👍🏾 Likes
                                                            </button>
                                                            {likes[index]}
                                                      ...
                                                      <div className="flex flex-col items-center">
                                                            <button className="text-my_black font-bold hover:text-my_white">
                                                                  👁️ Views
                                                            </button>
                                                            <span>
                                                                  {views[index]}
