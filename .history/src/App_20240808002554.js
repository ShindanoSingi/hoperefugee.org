      ...
      return (
        <Router>
            <div className="h-screen flex flex-col">
                <div className="bg-my_black p-2 h-16 flex items-center justify-between">
                    ...
                    <div className="h-12 w-12 rounded-full border-primary border flex items-center hidden sm:hidden md:hidden lg:block">
                    <MenuList toggled={isOpen} />
                    </div>
                </div>
