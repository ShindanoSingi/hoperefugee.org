      ...
      return (
            <footer class="bg-primary text-white">
                  <div class="max-w-screen-xl px-4 py-6 mx-auto sm:px-6 lg:px-8">
                        <div class="grid grid-cols-1 gap-8 lg:flex justify-between w-screen lg:grid-cols-3">
                              ...
                              <div class="grid grid-cols-1 gap-8 text-lg md:text-xl lg:col-span-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                    <div>
