  ...
  return (
    <div className="min-h-screen bg-contain bg-center bg-no-repeat bg-[url('/public/images/2.png')] md:bg-[url('/public/images/Anna_langing_page_big.png')]">
        <div className='flex justify-center items-center'>
            <ul className='text-primary flex gap-4 flex-col md:gap-2 text-[1.2rem] md:text-[1.4rem] font-montserrat relative top-[15rem] left-[5rem] md:left-0 md:top-[46rem] lg:md:top-[25rem] lg:md:left-[20rem]'>
                <li>Home</li>
                <li>About</li>
                <li>Services</li>
                <li>Portfolio</li>
