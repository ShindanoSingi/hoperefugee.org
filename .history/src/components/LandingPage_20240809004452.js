...
const LandingPage = () => {
      ...
      return (
            <div className=" bg-my_black h-full bg-no-repeat bg-[url('/public/images/Anna_langing_page_big.png')] bg-contain lg:bg-[url('/public/images/Anna_langing_page_big.png')]">
