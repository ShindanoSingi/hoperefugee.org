...
function CardImage({ item }) {
      return (
            <div class="relative flex flex-col break-words h-[39rem] md:h-[40rem] shadow-darkgrey bg-white w-full  shadow-lg rounded-lg">
                  <div className="flex flex-col">
                        <img
                              className="rounded-tl-lg h-[18rem] lg:h-[20rem] rounded-tr-lg"
