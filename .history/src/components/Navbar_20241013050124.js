  ...
  export default function Navbar() {
    ...
    return (
      <Disclosure as="nav" >
        ...
        <DisclosurePanel className=" bg-secondary pb-4 flex flex-col items-center lg:hidden">
          ...
          </div><Button type="primary" href="/donate" text='DONATE' border='white' hoverColor='primary'/>
        </DisclosurePanel>
