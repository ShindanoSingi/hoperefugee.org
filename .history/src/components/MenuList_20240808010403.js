...
function MenuList() {
      ...
      return (
            ...
            show ? <div class="flex left-[13.5rem] top-[20rem] md:top-[25rem] lg:top-0 lg:p-0 lg:left-0 md:left-[33rem] flex-col rounded-lg text-lg bg-my_black w-32 md:w-44 lg:flex-1 border border-primary text-primary shadow-yellow glow-border">
