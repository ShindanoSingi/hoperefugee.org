...
function MenuList() {
      return (
        <div class=" flex flex-col rounded-lg text-lg bg-my_black bg-clip-border top-[20rem] left-[15rem] w-32 md:w-48 lg:w-lg border border-primary text-primary shadow-yellow glow-border">
