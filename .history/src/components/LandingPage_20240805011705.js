...
const LandingPage = () => {
      ...
      return (
            <div className="min-h-screen bg-contain bg-no-repeat bg-[url('/public/images/2.png')] md:bg-[url('/public/images/Anna_langing_page_big.png') lg:bg-[url('/public/images/Anna_langing_page_big.png')]">
                  <MenuList />
                  {/* <Header />
