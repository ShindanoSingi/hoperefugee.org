...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-contain bg-center bg-no-repeat bg-[url('/public/images/2.png')] md:bg-[url('/public/images/Anna_langing_page_big.png')]">
        <ul className='text-primary hidden font-buffalo md:block lg:hidden flex gap-4 flex-col md:gap-2 md:text-[1.4rem] relative top-[20rem] left-[5rem] md:left-0 md:top-[46rem] lg:md:top-[25rem] lg:md:left-[20rem]'>
                <h1 className='font-buffalo'>Ani's</h1>
                <h1 className='font-buffalo'>BRAIDZ</h1>
            </ul>
        <div className='flex justify-center items-center'>
            <ul className='text-primary flex gap-4 flex-col md:gap-2 md:text-[1.4rem] font-montserrat relative top-[20rem] left-[5rem] md:left-0 md:top-[46rem] lg:md:top-[25rem] lg:md:left-[20rem]'>
                <li>Home</li>
                <li>About</li>
                <li>Services</li>
                <li>Portfolio</li>
