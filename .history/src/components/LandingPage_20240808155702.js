...
const LandingPage = () => {
      ...
      return (
            <div className=" bg-my_blackh-[80%] bg-no-repeat bg-[url('/public/images/Anna_langing_page_big.png')] bg-cover bg-center h-screen lg:bg-[url('/public/images/Anna_langing_page_big.png')]">
