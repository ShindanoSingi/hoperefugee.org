            ...
            <ul className='text-primary flex gap-4 flex-col md:gap-2 text-[1.2rem] md:text-[1.4rem] font-montserrat relative top-[18rem] left-[7rem] md:left-0 md:top-[46rem] lg:md:top-[25rem] lg:md:left-[20rem]'>
                ...
                <div x-data="{ open: false }" class="flex gap-5 items-center">
                    <img class="w-[60px] h-[60px] rounded-full "
                        src="https://tailwindcomponents.com/storage/avatars/uMR3f506SK0GdtIRAeZRVIBDOd5osmWeZ8Rvn2Oh.jpg" alt="profile picture"/>
                    <div>
                        <div class="text-white font-bold text-2xl">Ardiansyah Putra</div>
                        <div class="text-sm text-zinc-500 font-semibold">ardiansyahputra@gmail.com</div>
                    </div>
                </div>
            </ul>
        </div>
