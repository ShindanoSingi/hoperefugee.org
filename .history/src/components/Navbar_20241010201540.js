          ...
          <div className="space-y-1 px-2 pb-3 pt-2">
            {navigation.map((item) => (
              <DisclosureButton
                ...
                className={classNames(
                  location.pathname === item.href
                    ? "bg-gray-400 border rounded-lg text-white px-3 py-2 text-md"
                    : "text-gray-300 border rounded-lg  hover:bg-gray-700 hover:text-white",
                  "block px-3 py-2 text-md text-md"
                )}
              >
                {item.name}
              </DisclosureButton>
