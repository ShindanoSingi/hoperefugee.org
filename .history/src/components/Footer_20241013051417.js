                        ...
                        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                              <div className="flex flex-col gap-4 items-center">
                                    ...
                                    <div class="flex mt-8 space-x-6 text-white">
                                          <MdEmail className="text-white hover:text-white w-10 h-10" onClick={(e)=> {
                                             window.location.href = "mailto:max.shindano.singi@hoperefugee.org?";
                                             e.preventDefault();
                                          }} />
                                          <FaFacebookSquare className="text-white hover:text-white w-10 h-10" />
                                          <FaInstagramSquare className="text-white hover:text-white w-10 h-10" />
                                          <FaTwitterSquare className="text-white hover:text-white w-10 h-10" />
                                    </div>
                              </div>
