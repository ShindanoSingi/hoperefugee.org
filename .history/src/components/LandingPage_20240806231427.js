...
const LandingPage = () => {
      ...
      return (
            <div className=" bg-my_black flex-grow bg-no-repeat bg-[url('/public/images/2.png')] md:bg-contain bg-cover bg-center lg:bg-[url('/public/images/Anna_langing_page_big.png')]">
