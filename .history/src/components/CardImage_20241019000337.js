...
function CardImage({ item }) {
      return (
            <div class="relative flex flex-col break-words h-[36rem] md:h-[37rem] shadow-darkgrey bg-white w-full  shadow-lg rounded-lg">
                  <div className="flex flex-col">
                        ...
                        <div className="p-4">
                              ...
                              <Link>
                              <div className="text-bright text-lg md:text-xl">Read More</div>

                              <a href={`/card/${item.id}`}></a>
                              </Link>
                              </div>
                        </div>
                  </div>
