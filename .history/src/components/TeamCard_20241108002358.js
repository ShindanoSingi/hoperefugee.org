    ...
    <div key={index}>
        <div class=" bg-gray-900 w-[20rem] lg:h-[30rem]  lg:w-[30rem] rounded-lg shadow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div class="text-center">
                    <p class="text-xl md:text-2xl lg:text-3xl text-white font-bold mb-2">{contact.content}</p>
                    <p class="text-base md:text-xl lg:text-2xl text-gray-400 font-normal">{contact.role}</p>
                </div>
            </div>
    </div>
  )
