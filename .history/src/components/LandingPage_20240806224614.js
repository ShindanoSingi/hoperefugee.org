...
const LandingPage = () => {
      ...
      return (
            <div className=" bg-contain bg-my_black' bg-no-repeat bg-[url('/public/images/2.png')] bg-center md:bg-[url('/public/images/Anna_langing_page_big.png') lg:bg-[url('/public/images/Anna_langing_page_big.png')]">
