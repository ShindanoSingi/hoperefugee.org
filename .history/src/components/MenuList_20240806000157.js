...
function MenuList() {
      return (
        <div class=" flex flex-col rounded-lg text-lg bg-my_black bg-clip-border w-32 md:w-48 lg:w-screen border border-primary text-primary shadow-yellow glow-border">
