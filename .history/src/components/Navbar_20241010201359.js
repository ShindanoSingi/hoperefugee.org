  ...
  export default function Navbar() {
    ...
    return (
      <Disclosure as="nav" >
        ...
        <DisclosurePanel className="bg-lightblue lg:hidden">
          <div className="space-y-1 px-2 pb-3 pt-2">
            {navigation.map((item) => (
              <DisclosureButton
                ...
                className={classNames(
                  location.pathname === item.href
                    ? "bg-gray-400 border border-b-black rounded-lg text-white px-3 py-2 text-md font-medium"
                    : "text-gray-300 border rounded-lg border-b-black hover:bg-gray-700 hover:text-white",
