...
function MenuList() {
    ...
    const dispatch = useDispatch();
      ...
      return (
        ...
        !showMenu &&    <div class="flex absolute z-10 left-[15rem] top-[23rem] md:top-[16rem] lg:top-0 lg:p-2 lg:left-0 md:left-[33rem] flex-col rounded-lg text-lg bg-my_black w-32 md:w-44 lg:w-[30rem] border border-primary text-primary shadow-yellow glow-border">
