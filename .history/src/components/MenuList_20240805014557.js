...
function MenuList() {
      return (
            <div class="relative flex flex-col rounded-lg text-lg bg-my_black bg-clip-border top-[20rem] left-[15rem] md:top-[20rem] md:left-[15rem] w-32 border border-primary text-primary shadow-yellow">
