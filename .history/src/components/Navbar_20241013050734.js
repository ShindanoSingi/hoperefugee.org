          ...
          <div className="space-y-1 px-2 pb-3 pt-2">
            {navigation.map((item) => (
              <DisclosureButton
                ...
                className={classNames(
                  location.pathname === item.href
                    ? "bg-primary border rounded-lg text-xl text-blacktext px-3 py-2 text-md"
                    : "text-blacktext bg-primary border-lightblue text-xl border rounded-lg bg-lightblue  hover:bg-gray-700 hover:text-white",
