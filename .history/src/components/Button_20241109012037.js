...
const Button = ({ href, icon, text, type = 'default', border = 'black', hoverColor = 'default', width='w-[20rem]'}) => {
    ...
    return (
      <a
        href={href}
        className={`${buttonClasses[type]} ${borderClasses[border]} ${hoverClasses[hoverColor]} ${width} text-xl font-bold border-2 py-3 px-6 rounded-full flex items-center justify-center`}
