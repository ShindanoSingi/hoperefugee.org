...
const LandingPage = () => {
      ...
      return (
            <div className=" bg-my_black flex-grow bg-no-repeat bg-[url('/public/images/2.png')] bg-contain bg-center md:bg-[url('/public/images/2.png')]  lg:bg-[url('/public/images/Anna_langing_page_big.png')]">
