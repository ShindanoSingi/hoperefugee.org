      ...
      return (
            <Router>
                  <div className="h-screen flex flex-col">
                        <div className="bg-my_black p-2 h-14 border border-primary shadow-yellow lg:h-24 flex items-center justify-between lg:w-screen px-4">
                        ...
                        <div className="flex-1 lg:w-screen">
                              <Routes>
