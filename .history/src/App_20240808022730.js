            ...
            <Router>
                  <div className="h-screen flex flex-col">
                        <div className="bg-my_black p-2 h-20 shadow-yellow lg:h-24 flex items-center justify-between px-4">
                              ...
                              <div className="h-12 w-12 rounded-full shadow-yellow glow-border border-primary border flex items-center lg:hidden" onClick={() => SetShow(!show)}>
                                    <Hamburger
                                          toggled={isOpen}
                                          toggle={setOpen}
                                          size={32}
                        ...
                        <MenuList show={show} />
                              ...
                              <div className="hidden relative left-[48%] shadow-yellow glow-border lg:w-full lg:block">
                            <MenuList />
                              </div>
